...
module.exports = new lang.Class({
    ...
    _createModuleFromBuiltin: function(fullId) {
        ...
        try {
            this._cachedModules[fullId] = this._loadJsModule('thingpedia-builtins/' + builtinId);
    ...
    _createModuleFromCache: function(fullId, silent) {
        try {
            var modulePath = path.resolve(process.cwd(), this._cacheDir + '/' + fullId);
            this._cachedModules[fullId] = this._loadJsModule(modulePath);
