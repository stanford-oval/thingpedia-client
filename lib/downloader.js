...
module.exports = new lang.Class({
    ...
    _init: function(platform, client) {
    ...
    _loadJsModule: function(modulePath) {
    ...
    _createModuleFromBuiltin: function(id) {
        ...
        try {
            var modulePath = path.dirname(require.resolve('thingpedia-builtins/' + builtinId))
    ...
    _createModuleFromCache: function(id, silent) {
        try {
    ...
    _createModuleFromCachedCode: function(id) {
        var code;
        try {
    ...
    _getModuleRequest: function(id) {
        ...
        return this._moduleRequests[id].then(function(how) {
            if (how === 'code')
                return this._createModuleFromCachedFullcode(id);
            else
