...
module.exports = new lang.Class({
    ...
    _ensureModuleRequest: function(id) {
        ...
        this._moduleRequests[id] = this._client.getDeviceCode(id).then(function(response) {
            ...
            return this._client.getModuleLocation().then(function(redirect) {
                return Q.Promise(function(callback, errback) {
                    getModule(parsed).get(redirect, function(response) {
